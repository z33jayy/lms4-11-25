...
if ($user['role'] !== 'Teacher') {
    header("Location: homepage.php"); // Redirect to homepage2 if not a Teacher
    exit();
}
?>
...
<hr>
    <div>
      <h3 style="font-size: 1.5rem; font-family: Georgia, serif;">Cellphone Number:<?php echo htmlspecialchars($user['CellphoneNum']); ?></h3>
    </div>
    <hr>
    <div>
      <h3 style="font-size: 1.5rem; font-family: Georgia, serif;">Student ID: <?php echo htmlspecialchars($user['teacher_id']); ?><h3>
    </div>
<hr>
    <div>
